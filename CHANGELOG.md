...
- Installation command: `go install github.com/azizoid/zero-trust-tunnel-dashboard@latest`
- Project structure: `main.go` only in root directory
...
[Unreleased]: https://github.com/azizoid/zero-trust-tunnel-dashboard/compare/v1.7.6...HEAD
[1.7.6]: https://github.com/azizoid/zero-trust-tunnel-dashboard/compare/v1.6.0...v1.7.6
